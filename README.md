About lime-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lime-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/marcotcr/lime
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4938&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lime-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lime` can be installed with `conda`:
...
It is possible to list all of the versions of `lime` available on your platform with `conda`:
...
```
mamba search lime --channel conda-forge
```
...
mamba repoquery search lime --channel conda-forge

# List packages depending on `lime`:
mamba repoquery whoneeds lime --channel conda-forge

# List dependencies of `lime`:
mamba repoquery depends lime --channel conda-forge
```
